      ...
      <div className="mt-4 flex items-center justify-between text-sm text-muted-foreground">
        ...
        <div className="flex gap-2">
          <button
            ...
            className="p-2 aspect-square border border-border hover:bg-secondary rounded-md cursor-pointer disabled:cursor-not-allowed disabled:opacity-50"
          >
