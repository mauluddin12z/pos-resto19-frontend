...
const ActionButtons = ({
  ...
  <div className="flex gap-2 mt-2 justify-between">
    <div className="flex gap-2">
      <button
        onClick={onEdit}
        className="border border-blue-300 rounded-full text-blue-500 text-xs p-2.5 hover:bg-blue-600 hover:text-white cursor-pointer"
      >
        <Edit className="w-4 h-4" />
      </button>
      <button
        onClick={onDelete}
        className="border border-red-300 rounded-full text-red-500 text-xs p-2.5 hover:bg-red-600 hover:text-white cursor-pointer"
      >
